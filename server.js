...
const initialQs = () => {
    inquirer.prompt([
        ...
        .then(result => {
            ...
            //     viewByManager();
            // }
             if (result.option === 'Remove department') {
                 removeDept();
             }
        ...
        // };
          ...
          const removeDept = () => {
            ...
            db.query(sql, (err, rows) => {
              ...
              const departments = rows.map((dept) => dept.department_name);
              ...
              .then(selectDept => {
                ...
                db.query(sql, [selectDept.department],(err) => {
                  if (err) {
                    console.log(err);
                  }
